...
styles = {
    ...
    'Fullwidth': {
        'A': 'Ａ', 'B': 'Ｂ', 'C': 'Ｃ', 'D': 'Ｄ', 'E': 'Ｅ', 'F': 'Ｆ', 'G': 'Ｇ', 'H': 'Ｈ', 'I': 'Ｉ', 'J': 'Ｊ', 'K': 'Ｋ', 'L': 'Ｌ', 'M': 'Ｍ', 'N': 'Ｎ', 'O': 'Ｏ', 'Ｐ': 'Ｐ', 'Ｑ': 'Ｑ', 'Ｒ': 'Ｒ', 'Ｓ': 'Ｓ', 'Ｔ': 'Ｔ', 'Ｕ': 'Ｕ', 'Ｖ': 'Ｖ', 'Ｗ': 'Ｗ', 'Ｘ': 'Ｘ', 'Ｙ': 'Ｙ', 'Ｚ': 'Ｚ',
        'a': 'ａ', 'b': 'ｂ', 'c': 'ｃ', 'd': 'ｄ', 'e': 'ｅ', 'f': 'ｆ', 'g': 'ｇ', 'h': 'ｈ', 'i': 'ｉ', 'j': 'ｊ', 'k': 'ｋ', 'l': 'ｌ', 'm': 'ｍ', 'n': 'ｎ', 'o': 'ｏ', 'p': 'ｐ', 'ｑ': 'ｑ', 'ｒ': 'ｒ', 'ｓ': 'ｓ', 'ｔ': 'ｔ', 'ｕ': 'ｕ', 'ｖ': 'ｖ', 'ｗ': 'ｗ', 'ｘ': 'ｘ', 'ｙ': 'ｙ', 'ｚ': 'ｚ'
    }
}
...
def main(stdscr, input_text):
    ...
    # Copy the converted text to the clipboard using wl-copy
    subprocess.run(['wl-copy'], input=converted_text.encode('utf-8'))
